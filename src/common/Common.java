...
/**
 * Default parameters for the message interchange 
 * and other common static methods.
 */
public class Common {
    ...
    /**
     * Observer for the GUI application to know when a new connection 
     * is accepted.
     */
...
/* ----------------- */
     ...
     *          exists or no objects are stored there, an empty 
     ...
     * array with 4 positions. On the first one ({@code array[0]}) will be
     * the highest byte of the integer.
     *
     * @param port
    ...
    /**
     * Converts the given number (stored in the array of 4 bytes) into 
     * an integer. On {@code array[0]} will be the highest byte of the integer.
     *
     * @param array
     *              A byte array with the highest part of the number on
     *          {@code array[0]}.
